    ...
    var body: some View {
        tabView
            ...
            .overlay {
                ...
                .animation(.seventwosDefault, value: navigationTabCoordinator.overlayPresentationMode)
                .animation(.seventwosDefault, value: navigationTabCoordinator.overlayModule)
            }
    }
