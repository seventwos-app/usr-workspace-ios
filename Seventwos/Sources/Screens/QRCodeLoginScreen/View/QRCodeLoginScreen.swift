...
struct QRCodeLoginScreen_Previews: PreviewProvider, TestablePreview {
    ...
    static var previews: some View {
        SeventwosNavigationStack { QRCodeLoginScreen(context: loginInstructionsStateViewModel.context) }
            .previewDisplayName("Login instructions")
        SeventwosNavigationStack { QRCodeLoginScreen(context: linkInstructionsStateViewModel.context) }
            .previewDisplayName("Link instructions")
        
        SeventwosNavigationStack { QRCodeLoginScreen(context: scanningStateViewModel.context) }
            .previewDisplayName("Scanning")
        SeventwosNavigationStack { QRCodeLoginScreen(context: connectingStateViewModel.context) }
            .previewDisplayName("Connecting")
        SeventwosNavigationStack { QRCodeLoginScreen(context: invalidStateViewModel.context) }
            .previewDisplayName("Invalid")
        SeventwosNavigationStack { QRCodeLoginScreen(context: notAllowedStateViewModel.context) }
            .previewDisplayName("Not allowed")
        SeventwosNavigationStack { QRCodeLoginScreen(context: deviceNotSignedInStateViewModel.context) }
            .previewDisplayName("Device not signed in")
        
        SeventwosNavigationStack { QRCodeLoginScreen(context: showingStateViewModel.context) }
            .previewDisplayName("Showing")
        
        SeventwosNavigationStack { QRCodeLoginScreen(context: deviceCodeStateViewModel.context) }
            .previewDisplayName("Device code")
        SeventwosNavigationStack { QRCodeLoginScreen(context: verificationCodeStateViewModel.context) }
            .previewDisplayName("Verification code")
        
        SeventwosNavigationStack { QRCodeLoginScreen(context: confirmCodeStateViewModel.context) }
            .previewDisplayName("Confirm code")
        SeventwosNavigationStack { QRCodeLoginScreen(context: confirmCodeEnteredStateViewModel.context) }
            .previewDisplayName("Confirm code entered")
        SeventwosNavigationStack { QRCodeLoginScreen(context: confirmCodeInvalidStateViewModel.context) }
            .previewDisplayName("Confirm code invalid")
        
        SeventwosNavigationStack { QRCodeLoginScreen(context: errorStateViewModel.context) }
